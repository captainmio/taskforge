...
* `FTEST` - Review existing frontend tests related to the updated files or feature, then update them when needed. Create a separate, focused test only when the existing related coverage is insufficient. Do not add unrelated feature behavior.
...
* `BTEST` - Review existing backend tests related to the updated files or feature, then update them when needed. Create a separate, focused test only when the existing related coverage is insufficient. Do not add unrelated feature behavior.
