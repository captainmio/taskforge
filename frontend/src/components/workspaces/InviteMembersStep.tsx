              ...
              >
                ...
                <div className="mt-3 space-y-4">
                  <div>
                    ...
                    {emailError && (
                      <p
                        id={`invite-email-${field.id}-error`}
                  ...
                  <div>
                    ...
                    <select
                      ...
                      aria-describedby={
                        roleError ? `invite-role-${field.id}-error` : undefined
                      }
