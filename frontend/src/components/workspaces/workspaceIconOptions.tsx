...
import {
  WorkspaceIcon,
  type WorkspaceIcon as WorkspaceIconValue,
...
export const workspaceIconOptions = [
  {
    id: WorkspaceIcon.CODE,
    label: "Code workspace",
    icon: <FaCode />,
    className: "bg-green-50 text-site-green",
  },
  {
    id: WorkspaceIcon.BUSINESS,
    label: "Business workspace",
    icon: <FaBriefcase />,
    className: "bg-blue-50 text-blue-500",
  },
  {
    id: WorkspaceIcon.TEAM,
    label: "Team workspace",
    icon: <FaUsers />,
    className: "bg-purple-50 text-purple-500",
  },
  {
    id: WorkspaceIcon.LAUNCH,
    label: "Launch workspace",
    icon: <FaRocket />,
    className: "bg-orange-50 text-orange-500",
  },
  {
    id: WorkspaceIcon.GOALS,
    label: "Goals workspace",
    icon: <FaFlag />,
...
export const getWorkspaceIconOption = (
  ...
  return (
    workspaceIconOptions.find((option) => option.id === iconId) ??
