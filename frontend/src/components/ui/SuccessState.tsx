  ...
  return (
    <div className="text-center">
      <div className="relative mx-auto w-fit">
        ...
        <span
          className="absolute -left-5 top-2 size-2 rounded-full bg-amber-400"
          aria-hidden="true"
        />
        <span
          className="absolute -right-6 top-0 size-2 rounded-full bg-purple-400"
          aria-hidden="true"
        />
        <span
          className="absolute -left-7 bottom-1 size-1.5 rounded-full bg-blue-400"
          aria-hidden="true"
        />
        <span
          className="absolute -right-4 bottom-0 size-1.5 rounded-full bg-rose-400"
          aria-hidden="true"
        />
